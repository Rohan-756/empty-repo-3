        ...
        if (Array.isArray(items) && items.length > 0) {
          items.forEach((item: any, idx: number) => {
            transformedComponents.push({
              ...
              image_url: component.front_image_id ? `/api/files/lab-images/${component.front_image_id}` : null,
              back_image_url: component.back_image_id ? `/api/files/lab-images/${component.back_image_id}` : null,
...
export async function POST(request: NextRequest) {
  try {
    ...
    const transformedComponent = {
      ...
      imageUrl: component.front_image_id ? `/api/files/lab-images/${component.front_image_id}` : null,
      backImageUrl: component.back_image_id ? `/api/files/lab-images/${component.back_image_id}` : null,
      image_url: component.front_image_id ? `/api/files/lab-images/${component.front_image_id}` : null, // Add snake_case version
      back_image_url: component.back_image_id ? `/api/files/lab-images/${component.back_image_id}` : null, // Add snake_case version
      invoiceNumber: component.invoice_number,
      purchasedFrom: component.purchased_from,
      purchasedDate: component.purchase_date,
      purchasedValue: component.purchase_value,
